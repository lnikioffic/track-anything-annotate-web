...
from ml_core.Tracker.XMem2.model.aggregate import aggregate
from ml_core.Tracker.XMem2.model.memory_util import *
from ml_core.Tracker.XMem2.model.modules import *
...
class XMem(nn.Module):
    def __init__(
        ...
        model_path=None,
        map_location=None,
        pretrained_key_encoder=True,
        pretrained_value_encoder=True,
    ):
        """
        ...
        self.value_encoder = ValueEncoder(
            ...
            self.hidden_dim,
            self.single_object,
            pretrained=pretrained_value_encoder,
        )
