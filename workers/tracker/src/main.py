...
from src.services.storage import YandexDiskStorage
...
async def handle_message(data: dict, msg: RabbitMessage):
    storage = YandexDiskStorage(settings.YANDEX_DISK_TOKEN)
    try:
        ...
        print(
            f'storage_path={storage_path}, type={export_type}, metadata={items}',
        )
